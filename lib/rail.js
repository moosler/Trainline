class Rail {
    ...
    setCurve(type, width, height){
      ...
      /** Line Horizontal */
        ...
        control1 = {x:  this.pos.x + (width/4*3), y: this.mid.y};
        control2 = {x: this.pos.x+ (width/4), y:  this.mid.y};
      ...
      /** Line Vertical */
        ...
        control1 = {x:  this.mid.x, y: this.pos.y+(height/4*3)};
        control2 = {x: this.mid.x, y:  this.pos.y+(height/4)};
        end = {x: this.mid.x, y: this.pos.y};
      }
      let bezier = new Bezier(pos, control1, control2, end)
      this.line = bezier
