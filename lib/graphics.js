...
class Bezier {
  ...
  getOrient(t) {
    let g1 = this.calcMidpoint(this.control2, this.end, t);
    let g2 = this.calcMidpoint(this.control1, this.control2, t);
    let g3 = this.calcMidpoint(this.control1, this.pos, t);

    let b1 = this.calcMidpoint(g1, g2, t);
    let b2 = this.calcMidpoint(g2, g3, t);

    let c = this.calcMidpoint(b1, b2, t);
    let rad = Math.atan2(c.x, c.y, t);
    return rad;
  }
  calcMidpoint(p1, p2, t) {
    let x = (p1.x + p2.x) * t;
    let y = (p1.y + p2.y) * t;
    return { x: x, y: y };
  }
