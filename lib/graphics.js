...
class Bezier {
  constructor(pos, control, end, style = railStyle) {
    this.style = style
    this.pos = pos
  ...
  get() {
    ...
    bezierLine.bezierCurveTo(this.control.x1, this.control.y1, this.control.x2, this.control.y2, this.end.x, this.end.y);
    return bezierLine;
  }
}
