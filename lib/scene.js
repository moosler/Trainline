  ...
  recalcLevels(l_index) {
    ...
    for (let i = 0; i < textures.length; i++) {
      ...
      if (textureName != "blank.png") {
        let new_t = new PIXI.Sprite(textureId["blank.png"]);
        // let new_t = new PIXI.Sprite(textureId["blank_gold.png"]);
        el.texture = new_t.texture;
      }
      if (i > l_index) {
        break;
      }
...
class Scenewindow {
  ...
  addButtonGroup(buttonPos) {
    let buttons = ["select.png", "play.png"];
    let offset = 60;
